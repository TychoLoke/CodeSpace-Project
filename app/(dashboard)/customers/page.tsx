...
export default async function CustomersPage() {
  ...
  return (
    <AppShell
      ...
      actions={
        <button className="inline-flex items-center gap-3 rounded-xl border border-white/10 bg-[#101a32] px-5 py-2.5 text-sm font-semibold text-white shadow-[0_10px_40px_-28px_rgba(0,0,0,0.9)] transition hover:border-white/20 hover:bg-[#14223e]">
          <span className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-r from-[#ff5f6d] via-[#7c3aed] to-[#5b8bff] text-white shadow-[0_20px_40px_-26px_rgba(91,139,255,0.9)]">
